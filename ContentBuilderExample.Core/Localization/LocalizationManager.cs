...
namespace ContentBuilderExample.Core.Localization;
...
internal class LocalizationManager
{
    ...
    public static List<CultureInfo> GetSupportedCultures()
    {
        ...
        ResourceManager resourceManager = new ResourceManager("ContentBuilderExample.Core.Localization.Resources", assembly);
