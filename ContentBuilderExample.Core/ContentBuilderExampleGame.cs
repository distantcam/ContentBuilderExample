...
using ContentBuilderExample.Core.Effects;
using ContentBuilderExample.Core.Localization;
using ContentBuilderExample.Core.Settings;
using ContentBuilderExample.ScreenManagers;
using ContentBuilderExample.Screens;
using Microsoft.Xna.Framework;
using Microsoft.Xna.Framework.Graphics;

namespace ContentBuilderExample.Core
{
    /// <summary>
    ...
    /// </remarks>}
    public class ContentBuilderExampleGame : Game
    {
        ...
        private SettingsManager<ContentBuilderExampleSettings> settingsManager;

        // Manages leaderboard data for tracking high scores and achievements.
        private SettingsManager<ContentBuilderExampleLeaderboard> leaderboardManager;
        ...
        /// </summary>
        public ContentBuilderExampleGame()
        {
            ...
            settingsManager = new SettingsManager<ContentBuilderExampleSettings>(storage);
            Services.AddService(typeof(SettingsManager<ContentBuilderExampleSettings>), settingsManager);

            leaderboardManager = new SettingsManager<ContentBuilderExampleLeaderboard>(storage);
            Services.AddService(typeof(SettingsManager<ContentBuilderExampleLeaderboard>), leaderboardManager);
